...
const HARNESS_EXTENSION_VERSION = "0.2.2";
...
function legacyHarnessPatchPaths() {
	const paths = [fileURLToPath(new URL("../legacy/harness-v0.2.1.patch", import.meta.url)), fileURLToPath(new URL("../legacy/harness-v0.2.0.patch", import.meta.url))];
